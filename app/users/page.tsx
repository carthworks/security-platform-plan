      ...
      <div className="page-header" style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-end', flexWrap: 'wrap', gap: '16px' }}>
        <div>
          ...
          <p className="page-subtitle">
            Manage roles, view task workloads, and handle user credentials for the securityPlatform project boards.
          </p>
        </div>
            ...
            <form onSubmit={handleAddSubmit}>
              ...
              <div className="login-field" style={{ marginBottom: 12 }}>
                ...
                <div className="login-input-wrap">
                  ...
                  <input type="email" placeholder="john@securityPlatform.in" value={formEmail} onChange={(e) => setFormEmail(e.target.value)} required />
                </div>
              </div>
