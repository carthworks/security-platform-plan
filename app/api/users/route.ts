...
const INITIAL_USERS: DBUser[] = [
  { id: 'u1', name: 'administrator', email: 'admin@securityPlatform.in', role: 'admin', avatar: 'AK', avatarColor: 'av-orange', password: 'tf2025' },
  { id: 'u2', name: 'Rohan', email: 'dev@securityPlatform.in', role: 'developer', avatar: 'PS', avatarColor: 'av-teal', password: 'tf2025' },
  { id: 'u3', name: 'Karthik', email: 'karthik@securityPlatform.in', role: 'developer', avatar: 'K', avatarColor: 'av-purple', password: 'tf2025' },
  { id: 'u4', name: 'Sathish', email: 'sathish@securityPlatform.in', role: 'pm', avatar: 'S', avatarColor: 'av-amber', password: 'tf2025' },
  { id: 'u5', name: 'Ganesh', email: 'devops@securityPlatform.in', role: 'devops', avatar: 'GR', avatarColor: 'av-blue', password: 'tf2025' }
];
