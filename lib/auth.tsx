...
export const STATIC_USERS: Record<string, { password: string; user: User }> = {
  'admin@securityPlatform.in': {
    password: 'tf2025',
    user: { id: 'u1', name: 'administrator', email: 'admin@securityPlatform.in', role: 'admin', avatar: 'AK', avatarColor: 'av-orange' },
  },
  'dev@securityPlatform.in': {
    password: 'tf2025',
    user: { id: 'u2', name: 'dev', email: 'dev@securityPlatform.in', role: 'developer', avatar: 'PS', avatarColor: 'av-teal' },
  },
  'karthik@securityPlatform.in': {
    password: 'tf2025',
    user: { id: 'u3', name: 'Karthik', email: 'karthik@securityPlatform.in', role: 'pm', avatar: 'K', avatarColor: 'av-purple' },
  },
  'sathish@securityPlatform.in': {
    password: 'tf2025',
    user: { id: 'u4', name: 'Sathish', email: 'sathish@securityPlatform.in', role: 'pm', avatar: 'S', avatarColor: 'av-amber' },
  },
  'devops@securityPlatform.in': {
    password: 'tf2025',
    user: { id: 'u5', name: 'Ganesh', email: 'devops@securityPlatform.in', role: 'devops', avatar: 'GR', avatarColor: 'av-blue' },
  }
};
